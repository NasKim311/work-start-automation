						...
						{isEditing ? (
							...
							<>
								...
								<div className='flex items-center gap-2 sm:shrink-0 justify-end mt-2 sm:mt-0'>
									...
									<button onClick={() => testRun(task)} disabled={editingIndex !== null} className='mn-icon-btn p-2' title='테스트 실행'>
										<Play className='w-4 h-4' />
									</button>
									<button onClick={() => startEditing(i)} className='mn-icon-btn p-2' title='수정하기'>
